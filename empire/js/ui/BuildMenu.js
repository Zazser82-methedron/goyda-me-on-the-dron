...
import { BUILDINGS, BUILD_ORDER, CATS } from '../data/buildings.js?v=61';
import { RANKS } from '../data/ranks.js?v=61';
import { RES_LABEL } from '../data/config.js?v=61';
import { EDICTS } from '../sim/Edicts.js?v=61';
import { TECHS } from '../data/tech.js?v=61';
