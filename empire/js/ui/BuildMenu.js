...
import { BUILDINGS, BUILD_ORDER, CATS } from '../data/buildings.js?v=93';
import { RANKS } from '../data/ranks.js?v=93';
import { RES_LABEL } from '../data/config.js?v=93';
import { EDICTS } from '../sim/Edicts.js?v=93';
import { TECHS } from '../data/tech.js?v=93';
import { Thumbs } from './Thumbs.js?v=93';
