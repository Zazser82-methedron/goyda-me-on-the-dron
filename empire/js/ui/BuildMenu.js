...
import { BUILDINGS, BUILD_ORDER, CATS } from '../data/buildings.js?v=81';
import { RANKS } from '../data/ranks.js?v=81';
import { RES_LABEL } from '../data/config.js?v=81';
import { EDICTS } from '../sim/Edicts.js?v=81';
import { TECHS } from '../data/tech.js?v=81';
