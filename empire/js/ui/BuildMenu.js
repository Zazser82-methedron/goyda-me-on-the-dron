...
import { BUILDINGS, BUILD_ORDER, CATS } from '../data/buildings.js?v=44';
import { RANKS } from '../data/ranks.js?v=44';
import { RES_LABEL } from '../data/config.js?v=44';
import { EDICTS } from '../sim/Edicts.js?v=44';
import { TECHS } from '../data/tech.js?v=44';
