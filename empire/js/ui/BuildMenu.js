...
import { BUILDINGS, BUILD_ORDER, CATS } from '../data/buildings.js?v=80';
import { RANKS } from '../data/ranks.js?v=80';
import { RES_LABEL } from '../data/config.js?v=80';
import { EDICTS } from '../sim/Edicts.js?v=80';
import { TECHS } from '../data/tech.js?v=80';
