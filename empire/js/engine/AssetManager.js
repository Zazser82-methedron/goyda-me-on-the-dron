...
import { buildPlaceholder } from './Placeholders.js?v=107';
import { applyLibrary } from './MaterialLib.js?v=7';
...
export class AssetManager {
  constructor() {
    ...
    this.ver = '?v=114';   // кэш-бастер для GLB — бампится вместе со всеми ?v, чтобы новые модели доезжали до игрока
  }
