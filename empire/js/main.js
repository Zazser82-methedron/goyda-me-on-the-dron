...
import { Renderer } from './engine/Renderer.js?v=35';
import { RTSCamera } from './engine/RTSCamera.js?v=35';
import { Picker } from './engine/Picker.js?v=35';
import { Loop } from './engine/Loop.js?v=35';
import { AssetManager } from './engine/AssetManager.js?v=35';
import { TerrainMesh } from './world/TerrainMesh.js?v=35';
import { WorldBase } from './world/WorldBase.js?v=35';
import { Sky } from './world/Sky.js?v=35';
// Туман войны убран по просьбе игрока (Fog.js больше не используется)
import { nearestAdj } from './world/Pathfinding.js?v=35';
import { GameState } from './sim/GameState.js?v=35';
import * as Economy from './sim/Economy.js?v=35';
import * as BuildSys from './sim/Buildings.js?v=35';
import * as Waves from './sim/Waves.js?v=35';
import * as Tech from './sim/Tech.js?v=35';
import * as Nature from './sim/Nature.js?v=35';
import * as Relics from './sim/Relics.js?v=35';
import * as Camps from './sim/Camps.js?v=35';
import * as Wildlife from './sim/Wildlife.js?v=35';
import * as Research from './sim/Research.js?v=35';
import { updateUnits, damage } from './sim/Units.js?v=35';
import { toggleEdict } from './sim/Edicts.js?v=35';
import { sfx, toggleMute, isMuted, resumeAudio } from './audio/Sfx.js?v=35';
import { HUD } from './ui/HUD.js?v=35';
import { BuildMenu } from './ui/BuildMenu.js?v=35';
import { Selection } from './ui/Selection.js?v=35';
import { Minimap } from './ui/Minimap.js?v=35';
import { ResearchPanel } from './ui/Research.js?v=35';
import { Toasts } from './ui/Toasts.js?v=35';
import { BUILDINGS } from './data/buildings.js?v=35';
import { RANKS } from './data/ranks.js?v=35';
import { bark } from './data/barks.js?v=35';
import { STORAGE_KEY } from './data/config.js?v=35';
import { getFaction } from './data/factions.js?v=35';
import { getMap } from './data/maps.js?v=35';
import { StartScreen } from './ui/StartScreen.js?v=35';
