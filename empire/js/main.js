...
import { Renderer } from './engine/Renderer.js?v=45';
import { RTSCamera } from './engine/RTSCamera.js?v=45';
import { Picker } from './engine/Picker.js?v=45';
import { Loop } from './engine/Loop.js?v=45';
import { AssetManager } from './engine/AssetManager.js?v=45';
import { TerrainMesh } from './world/TerrainMesh.js?v=45';
import { WorldBase } from './world/WorldBase.js?v=45';
import { Sky } from './world/Sky.js?v=45';
import { Atmosphere } from './world/Atmosphere.js?v=45';
// Туман войны убран по просьбе игрока (Fog.js больше не используется)
import { nearestAdj } from './world/Pathfinding.js?v=45';
import { GameState } from './sim/GameState.js?v=45';
import * as Economy from './sim/Economy.js?v=45';
import * as BuildSys from './sim/Buildings.js?v=45';
import * as Waves from './sim/Waves.js?v=45';
import * as Tech from './sim/Tech.js?v=45';
import * as Nature from './sim/Nature.js?v=45';
import * as Relics from './sim/Relics.js?v=45';
import * as Camps from './sim/Camps.js?v=45';
import * as Wildlife from './sim/Wildlife.js?v=45';
import * as Research from './sim/Research.js?v=45';
import { updateUnits, damage } from './sim/Units.js?v=45';
import { toggleEdict } from './sim/Edicts.js?v=45';
import { sfx, toggleMute, isMuted, resumeAudio } from './audio/Sfx.js?v=45';
import { HUD } from './ui/HUD.js?v=45';
import { BuildMenu } from './ui/BuildMenu.js?v=45';
import { Selection } from './ui/Selection.js?v=45';
import { Minimap } from './ui/Minimap.js?v=45';
import { ResearchPanel } from './ui/Research.js?v=45';
import { Toasts } from './ui/Toasts.js?v=45';
import { Leaderboard } from './ui/Leaderboard.js?v=45';
import { BUILDINGS } from './data/buildings.js?v=45';
import { RANKS } from './data/ranks.js?v=45';
import { bark } from './data/barks.js?v=45';
import { STORAGE_KEY } from './data/config.js?v=45';
import { getFaction } from './data/factions.js?v=45';
import { getMap } from './data/maps.js?v=45';
import { StartScreen } from './ui/StartScreen.js?v=45';
