...
import { Renderer } from './engine/Renderer.js?v=27';
import { RTSCamera } from './engine/RTSCamera.js?v=27';
import { Picker } from './engine/Picker.js?v=27';
import { Loop } from './engine/Loop.js?v=27';
import { AssetManager } from './engine/AssetManager.js?v=27';
import { TerrainMesh } from './world/TerrainMesh.js?v=27';
import { WorldBase } from './world/WorldBase.js?v=27';
import { Sky } from './world/Sky.js?v=27';
// Туман войны убран по просьбе игрока (Fog.js больше не используется)
import { nearestAdj } from './world/Pathfinding.js?v=27';
import { GameState } from './sim/GameState.js?v=27';
import * as Economy from './sim/Economy.js?v=27';
import * as BuildSys from './sim/Buildings.js?v=27';
import * as Waves from './sim/Waves.js?v=27';
import * as Tech from './sim/Tech.js?v=27';
import * as Nature from './sim/Nature.js?v=27';
import * as Relics from './sim/Relics.js?v=27';
import * as Camps from './sim/Camps.js?v=27';
import * as Wildlife from './sim/Wildlife.js?v=27';
import * as Research from './sim/Research.js?v=27';
import { updateUnits, damage } from './sim/Units.js?v=27';
import { toggleEdict } from './sim/Edicts.js?v=27';
import { sfx, toggleMute, isMuted, resumeAudio } from './audio/Sfx.js?v=27';
import { HUD } from './ui/HUD.js?v=27';
import { BuildMenu } from './ui/BuildMenu.js?v=27';
import { Selection } from './ui/Selection.js?v=27';
import { Minimap } from './ui/Minimap.js?v=27';
import { ResearchPanel } from './ui/Research.js?v=27';
import { Toasts } from './ui/Toasts.js?v=27';
import { BUILDINGS } from './data/buildings.js?v=27';
import { RANKS } from './data/ranks.js?v=27';
import { bark } from './data/barks.js?v=27';
import { STORAGE_KEY } from './data/config.js?v=27';
import { getFaction } from './data/factions.js?v=27';
import { getMap } from './data/maps.js?v=27';
import { StartScreen } from './ui/StartScreen.js?v=27';
