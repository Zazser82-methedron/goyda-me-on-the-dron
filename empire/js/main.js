...
import { AssetManager } from './engine/AssetManager.js?v=130';
...
import { BuildingActivity } from './world/BuildingActivity.js?v=107';
...
import { GameState } from './sim/GameState.js?v=132';
...
class Game {
  ...
  _applySeason() {
    ...
    g.warmth.value = 0.01 + S.w;
    g.saturation.value = 1.34 + S.s;
