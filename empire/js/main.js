...
import { Renderer } from './engine/Renderer.js?v=91';
import * as Quality from './engine/Quality.js?v=91';
import { RTSCamera } from './engine/RTSCamera.js?v=91';
import { Picker } from './engine/Picker.js?v=91';
import { Loop } from './engine/Loop.js?v=91';
import { AssetManager } from './engine/AssetManager.js?v=91';
import { TerrainMesh } from './world/TerrainMesh.js?v=91';
import { WorldBase } from './world/WorldBase.js?v=91';
import { Sky } from './world/Sky.js?v=91';
import { Atmosphere } from './world/Atmosphere.js?v=91';
// Туман войны убран по просьбе игрока (Fog.js больше не используется)
import { nearestAdj } from './world/Pathfinding.js?v=91';
import { GameState } from './sim/GameState.js?v=91';
import * as Economy from './sim/Economy.js?v=91';
import * as BuildSys from './sim/Buildings.js?v=91';
import * as Waves from './sim/Waves.js?v=91';
import * as Tech from './sim/Tech.js?v=91';
import * as Nature from './sim/Nature.js?v=91';
import * as Relics from './sim/Relics.js?v=91';
import * as Camps from './sim/Camps.js?v=91';
import * as Wildlife from './sim/Wildlife.js?v=91';
import * as Events from './sim/Events.js?v=91';
import * as Achievements from './sim/Achievements.js?v=91';
import * as Meta from './sim/Meta.js?v=91';
import * as Research from './sim/Research.js?v=91';
import { updateUnits, damage } from './sim/Units.js?v=91';
import { toggleEdict } from './sim/Edicts.js?v=91';
import { sfx, toggleMute, isMuted, resumeAudio } from './audio/Sfx.js?v=91';
import { AmbientAudio } from './audio/Music.js?v=91';
import { HUD } from './ui/HUD.js?v=91';
import { BuildMenu } from './ui/BuildMenu.js?v=91';
import { Selection } from './ui/Selection.js?v=91';
import { Minimap } from './ui/Minimap.js?v=91';
import { ResearchPanel } from './ui/Research.js?v=91';
import { Toasts } from './ui/Toasts.js?v=91';
import { Leaderboard } from './ui/Leaderboard.js?v=91';
import { BUILDINGS } from './data/buildings.js?v=91';
import { RANKS } from './data/ranks.js?v=91';
import { bark } from './data/barks.js?v=91';
import { STORAGE_KEY } from './data/config.js?v=91';
import { getFaction } from './data/factions.js?v=91';
import { getMap, MAPS } from './data/maps.js?v=91';
import { StartScreen } from './ui/StartScreen.js?v=91';
