...
import { Renderer } from './engine/Renderer.js?v=23';
import { RTSCamera } from './engine/RTSCamera.js?v=23';
import { Picker } from './engine/Picker.js?v=23';
import { Loop } from './engine/Loop.js?v=23';
import { AssetManager } from './engine/AssetManager.js?v=23';
import { TerrainMesh } from './world/TerrainMesh.js?v=23';
import { WorldBase } from './world/WorldBase.js?v=23';
import { Sky } from './world/Sky.js?v=23';
// Туман войны убран по просьбе игрока (Fog.js больше не используется)
import { nearestAdj } from './world/Pathfinding.js?v=23';
import { GameState } from './sim/GameState.js?v=23';
import * as Economy from './sim/Economy.js?v=23';
import * as BuildSys from './sim/Buildings.js?v=23';
import * as Waves from './sim/Waves.js?v=23';
import * as Tech from './sim/Tech.js?v=23';
import * as Nature from './sim/Nature.js?v=23';
import * as Relics from './sim/Relics.js?v=23';
import * as Camps from './sim/Camps.js?v=23';
import * as Wildlife from './sim/Wildlife.js?v=23';
import * as Research from './sim/Research.js?v=23';
import { updateUnits, damage } from './sim/Units.js?v=23';
import { toggleEdict } from './sim/Edicts.js?v=23';
import { sfx, toggleMute, isMuted, resumeAudio } from './audio/Sfx.js?v=23';
import { HUD } from './ui/HUD.js?v=23';
import { BuildMenu } from './ui/BuildMenu.js?v=23';
import { Selection } from './ui/Selection.js?v=23';
import { Minimap } from './ui/Minimap.js?v=23';
import { ResearchPanel } from './ui/Research.js?v=23';
import { Toasts } from './ui/Toasts.js?v=23';
import { BUILDINGS } from './data/buildings.js?v=23';
import { RANKS } from './data/ranks.js?v=23';
import { bark } from './data/barks.js?v=23';
import { STORAGE_KEY } from './data/config.js?v=23';
import { getFaction } from './data/factions.js?v=23';
import { getMap } from './data/maps.js?v=23';
import { StartScreen } from './ui/StartScreen.js?v=23';
