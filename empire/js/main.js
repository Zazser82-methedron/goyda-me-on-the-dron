...
import { Renderer } from './engine/Renderer.js?v=65';
import { RTSCamera } from './engine/RTSCamera.js?v=65';
import { Picker } from './engine/Picker.js?v=65';
import { Loop } from './engine/Loop.js?v=65';
import { AssetManager } from './engine/AssetManager.js?v=65';
import { TerrainMesh } from './world/TerrainMesh.js?v=65';
import { WorldBase } from './world/WorldBase.js?v=65';
import { Sky } from './world/Sky.js?v=65';
import { Atmosphere } from './world/Atmosphere.js?v=65';
// Туман войны убран по просьбе игрока (Fog.js больше не используется)
import { nearestAdj } from './world/Pathfinding.js?v=65';
import { GameState } from './sim/GameState.js?v=65';
import * as Economy from './sim/Economy.js?v=65';
import * as BuildSys from './sim/Buildings.js?v=65';
import * as Waves from './sim/Waves.js?v=65';
import * as Tech from './sim/Tech.js?v=65';
import * as Nature from './sim/Nature.js?v=65';
import * as Relics from './sim/Relics.js?v=65';
import * as Camps from './sim/Camps.js?v=65';
import * as Wildlife from './sim/Wildlife.js?v=65';
import * as Events from './sim/Events.js?v=65';
import * as Achievements from './sim/Achievements.js?v=65';
import * as Research from './sim/Research.js?v=65';
import { updateUnits, damage } from './sim/Units.js?v=65';
import { toggleEdict } from './sim/Edicts.js?v=65';
import { sfx, toggleMute, isMuted, resumeAudio } from './audio/Sfx.js?v=65';
import { AmbientAudio } from './audio/Music.js?v=65';
import { HUD } from './ui/HUD.js?v=65';
import { BuildMenu } from './ui/BuildMenu.js?v=65';
import { Selection } from './ui/Selection.js?v=65';
import { Minimap } from './ui/Minimap.js?v=65';
import { ResearchPanel } from './ui/Research.js?v=65';
import { Toasts } from './ui/Toasts.js?v=65';
import { Leaderboard } from './ui/Leaderboard.js?v=65';
import { BUILDINGS } from './data/buildings.js?v=65';
import { RANKS } from './data/ranks.js?v=65';
import { bark } from './data/barks.js?v=65';
import { STORAGE_KEY } from './data/config.js?v=65';
import { getFaction } from './data/factions.js?v=65';
import { getMap } from './data/maps.js?v=65';
import { StartScreen } from './ui/StartScreen.js?v=65';
