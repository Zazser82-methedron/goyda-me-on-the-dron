...
import { Renderer } from './engine/Renderer.js?v=26';
import { RTSCamera } from './engine/RTSCamera.js?v=26';
import { Picker } from './engine/Picker.js?v=26';
import { Loop } from './engine/Loop.js?v=26';
import { AssetManager } from './engine/AssetManager.js?v=26';
import { TerrainMesh } from './world/TerrainMesh.js?v=26';
import { WorldBase } from './world/WorldBase.js?v=26';
import { Sky } from './world/Sky.js?v=26';
// Туман войны убран по просьбе игрока (Fog.js больше не используется)
import { nearestAdj } from './world/Pathfinding.js?v=26';
import { GameState } from './sim/GameState.js?v=26';
import * as Economy from './sim/Economy.js?v=26';
import * as BuildSys from './sim/Buildings.js?v=26';
import * as Waves from './sim/Waves.js?v=26';
import * as Tech from './sim/Tech.js?v=26';
import * as Nature from './sim/Nature.js?v=26';
import * as Relics from './sim/Relics.js?v=26';
import * as Camps from './sim/Camps.js?v=26';
import * as Wildlife from './sim/Wildlife.js?v=26';
import * as Research from './sim/Research.js?v=26';
import { updateUnits, damage } from './sim/Units.js?v=26';
import { toggleEdict } from './sim/Edicts.js?v=26';
import { sfx, toggleMute, isMuted, resumeAudio } from './audio/Sfx.js?v=26';
import { HUD } from './ui/HUD.js?v=26';
import { BuildMenu } from './ui/BuildMenu.js?v=26';
import { Selection } from './ui/Selection.js?v=26';
import { Minimap } from './ui/Minimap.js?v=26';
import { ResearchPanel } from './ui/Research.js?v=26';
import { Toasts } from './ui/Toasts.js?v=26';
import { BUILDINGS } from './data/buildings.js?v=26';
import { RANKS } from './data/ranks.js?v=26';
import { bark } from './data/barks.js?v=26';
import { STORAGE_KEY } from './data/config.js?v=26';
import { getFaction } from './data/factions.js?v=26';
import { getMap } from './data/maps.js?v=26';
import { StartScreen } from './ui/StartScreen.js?v=26';
