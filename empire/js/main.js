...
import { Renderer } from './engine/Renderer.js?v=43';
import { RTSCamera } from './engine/RTSCamera.js?v=43';
import { Picker } from './engine/Picker.js?v=43';
import { Loop } from './engine/Loop.js?v=43';
import { AssetManager } from './engine/AssetManager.js?v=43';
import { TerrainMesh } from './world/TerrainMesh.js?v=43';
import { WorldBase } from './world/WorldBase.js?v=43';
import { Sky } from './world/Sky.js?v=43';
import { Atmosphere } from './world/Atmosphere.js?v=43';
// Туман войны убран по просьбе игрока (Fog.js больше не используется)
import { nearestAdj } from './world/Pathfinding.js?v=43';
import { GameState } from './sim/GameState.js?v=43';
import * as Economy from './sim/Economy.js?v=43';
import * as BuildSys from './sim/Buildings.js?v=43';
import * as Waves from './sim/Waves.js?v=43';
import * as Tech from './sim/Tech.js?v=43';
import * as Nature from './sim/Nature.js?v=43';
import * as Relics from './sim/Relics.js?v=43';
import * as Camps from './sim/Camps.js?v=43';
import * as Wildlife from './sim/Wildlife.js?v=43';
import * as Research from './sim/Research.js?v=43';
import { updateUnits, damage } from './sim/Units.js?v=43';
import { toggleEdict } from './sim/Edicts.js?v=43';
import { sfx, toggleMute, isMuted, resumeAudio } from './audio/Sfx.js?v=43';
import { HUD } from './ui/HUD.js?v=43';
import { BuildMenu } from './ui/BuildMenu.js?v=43';
import { Selection } from './ui/Selection.js?v=43';
import { Minimap } from './ui/Minimap.js?v=43';
import { ResearchPanel } from './ui/Research.js?v=43';
import { Toasts } from './ui/Toasts.js?v=43';
import { Leaderboard } from './ui/Leaderboard.js?v=43';
import { BUILDINGS } from './data/buildings.js?v=43';
import { RANKS } from './data/ranks.js?v=43';
import { bark } from './data/barks.js?v=43';
import { STORAGE_KEY } from './data/config.js?v=43';
import { getFaction } from './data/factions.js?v=43';
import { getMap } from './data/maps.js?v=43';
import { StartScreen } from './ui/StartScreen.js?v=43';
