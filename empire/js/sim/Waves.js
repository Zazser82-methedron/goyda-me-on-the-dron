...
import { UNITS } from '../data/units.js?v=38';
import { BOSSES } from '../data/bosses.js?v=38';
import { bark } from '../data/barks.js?v=38';
import { hostileFor } from '../data/factions.js?v=38';
import { floodReachable } from '../world/Pathfinding.js?v=38';
